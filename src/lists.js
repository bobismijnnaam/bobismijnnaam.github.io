...
List.prototype.copy = function () {
    // This is a shallow copy, but it 
    // suffices for list of integers for
    // instance, which is enough for 
    // the verification prototype
    var idx, result = new List();
    for(idx = 1; idx <= this.length(); idx += 1) {
        result.add(this.at(idx));
    }
    return result;
}
