...
SpriteMorph.prototype.initBlocks = function () {
    SpriteMorph.prototype.blocks = {
        ...
        reportForall: {
          type: 'predicate',
          category: 'lists',
          spec:'Forall %upvar from %s to %s happens %boolUE',
          defaults: [localize('idx'), 1, 10]
        },
        reportExists: {
            type: 'predicate',
            category: 'lists',
            spec:'Exists %upvar between %s and %s such that %boolUE',
            defaults: [localize('idx'), 1, 10]
        },
        reportResult: {
            type: 'reporter',
        ...
        doUntilWithInvariant: {
            type: 'command',
            category: 'control',
            spec: 'repeat until %b %br    invariant %mult%b %loop %br    invariant'
        },
        doWhileWithInvariant: {
            type: 'command',
            category: 'control',
            spec: 'repeat while %b %br    invariant %mult%b %loop %br    invariant'
        },
        doForWithInvariant: {
            type: 'command',
            category: 'control',
            spec: 'for %upvar = %n to %n %br   invariant %boolUE %cla %br   invariant',
            defaults: ['i', 1, 10]
        },
    };
};
...
SpriteMorph.prototype.blockAlternatives = {
    ...
    doFor : ['doForWithInvariant'],
    doUntilWithInvariant : ['doWhileWithInvariant'],
    doWhileWithInvariant : ['doUntilWithInvariant'],
    ...
    reportLessThan: ['reportEquals', 'reportGreaterThan', 'reportLessOrEqual', 'reportGreaterOrEqual'],
    reportEquals: ['reportLessThan', 'reportGreaterThan', 'reportLessOrEqual', 'reportGreaterOrEqual'],
    reportGreaterThan: ['reportEquals', 'reportLessThan', 'reportLessOrEqual', 'reportGreaterOrEqual'],
    reportGreaterOrEqual: ['reportEquals', 'reportLessThan', 'reportGreaterThan', 'reportLessOrEqual'],
    reportLessOrEqual: ['reportEquals', 'reportLessThan', 'reportGreaterThan', 'reportGreaterOrEqual'],
    reportAnd: ['reportOr'],
    reportOr: ['reportAnd'],
    ...
    reportForall: ['reportExists'],
    reportExists: ['reportForall'],
};
...
SpriteMorph.prototype.blockTemplates = function (category) {
    ...
    /////////////////////////////////
        ...
        blocks.push(block('doUntilWithInvariant'));
        blocks.push(block('doWhileWithInvariant'));
        blocks.push(block('doFor'));
        blocks.push(block('doForWithInvariant'));
        blocks.push('-');
	...
	/////////////////////////////////
        ...
        blocks.push(block('reportNeq'));
        blocks.push(block('reportGreaterThan'));
        blocks.push(block('reportLessOrEqual'));
        blocks.push(block('reportGreaterOrEqual'));
        blocks.push('-');
    ...
    /////////////////////////////////
        ...
        blocks.push(block('reportResult'));
        blocks.push(block('reportOld'));
    ...
    ///////////////////////////////
        ...
        blocks.push(block('reportForall'));
        blocks.push(block('reportExists'));
        blocks.push('-');
    ...
    //     blocks.push(block('reportExists'));
    //     blocks.push(block('reportResult'));
    //     blocks.push(block('reportOldValue'));
    //     blocks.push(block('doForEachWithInvariant'));
    //     blocks.push(block('doUntilWithInvariant'));
    //     blocks.push(block('reportRange'));
